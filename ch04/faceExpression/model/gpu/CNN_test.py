...
classification_model_path = 'model/model_cnn_gpu.pth'
...
emotion_classifier = FaceCNN().to(device)
emotion_classifier.load_state_dict(torch.load(classification_model_path, map_location=device))
