...
data_train = FaceDataset(root=r'C:\Users\17216\Desktop\ai_lab\ch04\faceExpression\data\pre_process\train_set')
data_vaild = FaceDataset(root=r'C:\Users\17216\Desktop\ai_lab\ch04\faceExpression\data\pre_process\verify_set')
...
def RUN():
    for epoch in range(1,EPOCH+1):
        ...
        torch.save(model,r'C:\Users\17216\Desktop\ai_lab\ch04\faceExpression\model\gpu\model_resnet_gpu.pth')
