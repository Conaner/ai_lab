...
xml_dir = '/root/defect-detection/data/NEU-DET/train/annatation'
output_dir = '/root/defect-detection/data/NEU-DET/train/labels'  # Output directory for YOLO format files

test_xml_dir = '/root/defect-detection/data/NEU-DET/test/annatation'
test_output_dir = '/root/defect-detection/data/NEU-DET/test/labels'  # Output directory for YOLO format files
